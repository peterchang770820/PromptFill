...
export const INITIAL_TEMPLATES_CONFIG = [
  ...
  },
  {
    ...
    "selections": {
      ...
      "clothing": {
        "zh-tw": "極簡黑色高級定製禮服",
        "en": "Minimalist black couture gown"
      },
      "background_style": {
        "zh-tw": "乾淨的純白影棚背景",
        "en": "Clean pure white studio background"
      },
      "lighting": {
        "zh-tw": "柔和的編輯級影棚布光",
        "en": "Soft editorial studio lighting"
      },
      "ratio": {
        "zh-tw": "3:4豎構圖",
        "en": "3:4 Vertical"
